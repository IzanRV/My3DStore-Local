    ...
    <footer id="footer" class="bg-primary text-white py-20">
    ...
    <button type="button" id="btnSubir" class="fixed left-4 bottom-8 w-12 h-12 flex items-center justify-center bg-primary text-white hover:bg-primary/90 rounded-[50%] shadow-lg hover:shadow-xl transition-all duration-300 z-50 opacity-0 pointer-events-none" aria-label="Ir arriba">
