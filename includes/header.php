...
<a href="#footer" class="hidden lg:flex items-center gap-2 px-4 py-2 text-sm font-medium hover:text-primary transition-colors text-slate-700 dark:text-slate-200">
                    Contacto
                </a>
    ...
    <div class="flex flex-col h-full">
        ...
        <div class="flex-1 px-6 py-4 space-y-6">
            ...
            <div class="space-y-3">
                ...
                <a href="#footer" class="flex items-center gap-3 text-white hover:text-blue-300 transition-colors">
